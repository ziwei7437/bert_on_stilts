...
def main():
    ...
    if args.only_train_classifier:
        ...
        torch.save(runner_classifier.training_state.tr_loss,
                   os.path.join(args.output_dir, "minibatch_training_loss.list"))
        torch.save(runner_classifier.training_state.epoch_loss,
                   os.path.join(args.output_dir, "epoch_training_loss.list"))
